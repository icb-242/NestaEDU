...
export { PromptWorkbenchSlideComponent as PromptWorkbenchSlide } from "./PromptWorkbenchSlide";
export { ReflectionSlideComponent as ReflectionSlide } from "./ReflectionSlide";
export { ChecklistSlideComponent as ChecklistSlide } from "./ChecklistSlide";
export { QuizSlideComponent as QuizSlide } from "./QuizSlide";
